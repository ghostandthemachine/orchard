(ns orchard.util.module
  ...
  (:require
    ...
    [orchard.util.core :refer [index-of]]
  ...
  (let [index (case type
    ...
    [:div.popover-container
      (for [icon [(create-module-icon template index
                    orchard.objects.modules.tiny-mce/icon
                    orchard.objects.modules.tiny-mce/create-module)
                  (create-module-icon template index
                    orchard.objects.modules.markdown/icon
                    orchard.objects.modules.markdown/create-module)
                  (create-module-icon template index
                    orchard.objects.modules.html/icon
                    orchard.objects.modules.html/create-module)
                  (create-module-icon template index
                    orchard.objects.modules.media/icon
                    orchard.objects.modules.media/create-module)]]
