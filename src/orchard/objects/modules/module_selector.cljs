(ns orchard.objects.modules.module-selector
  ...
  (:require 
    ...
    [orchard.module :refer [module-btn module-btn-icon]]
    [orchard.module :as modules]
    [orchard.objects.modules.markdown :as md]
    [orchard.objects.modules.media :as media]
    [orchard.objects.modules.visualizer :as viz]
    [orchard.objects.modules.html :as html]
