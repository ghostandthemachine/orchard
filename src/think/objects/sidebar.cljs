...
(object/behavior* ::open!
                  ...
                  :reaction (fn [this]
                              ...
                              (object/merge! (:wiki-document @think.objects.workspace/workspace) {:left (+ 30 (:max-width @this))}) ;; set doc container width
                              ))
...
(object/behavior* ::close!
                  :triggers #{:close!}
                  :reaction (fn [this]
                              (object/merge! (:wiki-document @think.objects.workspace/workspace) {:left 30}) ;; reset doc container width
